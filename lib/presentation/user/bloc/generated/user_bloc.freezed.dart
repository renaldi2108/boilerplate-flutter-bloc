...
/// @nodoc
mixin _$UserState {
  BaseState<List<UserEntity>> get userState =>
      throw _privateConstructorUsedError;
...
abstract class $UserStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({BaseState<List<UserEntity>> userState});

  $BaseStateCopyWith<List<UserEntity>, $Res> get userState;
}
...
class _$UserStateCopyWithImpl<$Res, $Val extends UserState>
  ...
  @pragma('vm:prefer-inline')
  $BaseStateCopyWith<List<UserEntity>, $Res> get userState {
    return $BaseStateCopyWith<List<UserEntity>, $Res>(_value.userState,
        (value) {
...
class _$UserStateImpl implements _UserState {
  const _$UserStateImpl({this.userState = const BaseState.initial()});

  @override
  @JsonKey()
  final BaseState<List<UserEntity>> userState;
...
abstract class _UserState implements UserState {
  const factory _UserState({final BaseState<List<UserEntity>> userState}) =
      _$UserStateImpl;
